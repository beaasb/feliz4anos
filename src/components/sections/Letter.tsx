...
export function LetterSection() {
  return (
    <section id="carta" className="scroll-mt-8 flex items-center justify-center px-6 py-16">
      <div className="max-w-2xl w-full">
        ...
        >
          <div className="font-script text-2xl dark:text-red-900 md:text-3xl leading-[2rem] md:leading-[2.2rem] text-foreground/85 space-y-6">
            <p>Meu amor,</p>
            <p>
